    ...
    >
      <div className="max-w-9xl mx-auto p-6">
        <div className="flex justify-between items-center">
          ...
          <div
            ref={menuRef}
            className={`absolute md:relative top-16 left-0 md:top-0 md:left-auto w-full md:w-auto bg-opacity-90 backdrop-blur-md bg-white
             md:flex md:items-center md:space-x-6 p-5 md:p-0 transition-all ${
