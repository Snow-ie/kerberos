/* app/services/consulting/technology-info/page.js */
"use client";

import ServiceHero from "../../components/ServiceHero";
import NextButton from "../../components/NextButton"; // adjust path if needed
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="mt-auto w-full max-w-3xl mx-auto px-4 pb-12 flex justify-end">
        <NextButton href="/services/consulting/energy-info" />
      </div>
    </div>
  );
}
